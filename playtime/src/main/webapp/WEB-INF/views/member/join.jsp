...
/* css======================= */
		*{
		...
		.n_logo{
			...
			width: 770px;
			height: 138px;
			background: url("${path}/resources/img/cpt.png") 0 -13px; /*../img/naver/pc_sp_join.png*/
				...
				<div class="join_content">
					 <div class="row_group">
					 	<div class="join_row">
					 		...
					 		<span class="ps_box int_id">
					 			<input type="text" id="uid" name="id" class="int join_info_box_input">
					 ...
					 <div class="row_group">
					 	<div class="join_row">
					 		...
					 		<span class="ps_box">
					 			<input type="text" id="uname" name="name" class="int join_info_box_input">
					 		</span>
					 		<span class="error_next_box">필수 정보입니다</span>
					 	</div>
					 	...
					 	<div class="join_row">
					 		...
					 		<span class="ps_box">
					 			<input type="text" id="uemail" name="email" class="int join_info_box_input" placeholder="선택입력">
					 		</span>
					 		<span class="error_next_box">필수 정보입니다</span>
					 	</div>
						...
						<div class="join_row addr_box">
					 		...
					 		<span class="ps_box">
					 			<input type="text" class="addr_only join_info_box_input" id="sample6_postcode" placeholder="우편번호" >
								<input type="button" id="btn_post" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"></span>
							<span class="ps_box">
								<input type="text" class="addr_only join_info_box_input" id="sample6_address" placeholder="주소" ></span>
							<span class="ps_box">
								<input type="text" class= "join_info_box_inputid=" sample6_detailAddress" placeholder="상세주소"></span>
	...
	<footer>
			<div id="footer">
				...
				<div id="address">
					...
					<span>Copyright</span>
					<span>ⓒ</span>
					<span><strong><a href="#">Play time.</a></strong></span>
			...
			$(function(){
				...
				$('#sample6_detailAddress').keyup(function(){
					...
					if(result.code == 3) { //우편번호 & 주소 X 
						ckDesign(result.code, result.desc, 8, 10);	
						ckDesign(result.code, result.desc, 7, 10);
						checkArr[5] = false;
					} else if (result.code == 0) { // 상세주소 X
						checkArr[5] = true;
						ckDesign(result.code, result.desc, 7, 10);
						ckDesign(result.code, result.desc, 8, 10);
						ckDesign(result.code, result.desc, 9, 10);

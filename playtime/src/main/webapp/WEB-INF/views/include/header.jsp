...
<title>playtime</title>
	...
	<style type="text/css">
		...
		.header_content_dropdown_group:hover > div > a,
...
<div class="modal_wrap">		
		<div class="modal_content">
			...
			<div class="t_header box">
				<div class="title_logo"><img class='max-small' src="../../img/블래키.png"></div>
				<div class="header_title"><h3>PlayTime에 오신 것을 환영합니다</h3></div>			
				<form>
					<div class="login_box">
						<form>
							<div class="login_content">
								<div class="login_t" id="login_id"><input type="email" placeholder="이메일" required></div>
								<div class="login_t" id="login_pw">
									<input type="text" placeholder="비밀번호" required minlength="6" maxlength="18">
									<span class="pw_eye">
					...
					<div class="sns_btn box">
						<div class="face_btn btn-common"><h3>Facebook으로 계속하기</h3></div>
						<div class="google_btn btn-common"><h3>Google로 계속하기</h3></div>
					</div>

					<div class="footer">
						<div class="footer_private">계속하면 <a href="#">서비스약관</a> 및 <a href="#">개인정보
						보호정책</a>에 동의하는 것으로 간주됩니다</div>
						<div class="line"></div>						
		...
		<div class="header_wrap">
			<div class="header_content">
				<div class="header_content_logo">
					<a href="">
					<img class="header_content_logo_img" src="../../img/cat_playtime_big2.png" alt="로고이미지">					<!-- <span class="header_content_logo_text">PlayTime</span> -->
					</a>
				</div>
			
			<div class="header_content_nav">

				<div class="header_content_dropdown_group"><a href="#" class="magicline">할인</a></div>
			...
			<div class="header_content_member">
				...
				<div>
					<div class="header_content_member_cart">
						<a href="#"><i class="fas fa-cart-arrow-down"></i></a></div>
				</div>	
